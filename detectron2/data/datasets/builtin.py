...
_PREDEFINED_CD = [
    ...
    ("dataset1_pseudo_1shot", "dataset1/train", "dataset1/annotations/1_shot.json"),
    ("dataset1_pseudo_5shot", "dataset1/train", "dataset1/annotations/5_shot.json"),
    ("dataset1_pseudo_10shot", "dataset1/train", "dataset1/annotations/10_shot.json"),

    # dataset2 pseudo few-shot
    ("dataset2_pseudo_1shot", "dataset2/train", "dataset2/annotations/1_shot.json"),
    ("dataset2_pseudo_5shot", "dataset2/train", "dataset2/annotations/5_shot.json"),
    ("dataset2_pseudo_10shot", "dataset2/train", "dataset2/annotations/10_shot.json"),

    # dataset3 pseudo few-shot
    ("dataset3_pseudo_1shot", "dataset3/train", "dataset3/annotations/1_shot.json"),
    ("dataset3_pseudo_5shot", "dataset3/train", "dataset3/annotations/5_shot.json"),
    ("dataset3_pseudo_10shot", "dataset3/train", "dataset3/annotations/10_shot.json"),
]
...
for shot in [1, 5, 10]:
    ...
    _PREDEFINED_CD.append(
        ("dataset1_{}shot".format(shot),
         "dataset1/train_aug",
         "dataset1/annotations_aug/{}_shot.json".format(shot))
    )

    _PREDEFINED_CD.append(
        ("dataset2_{}shot".format(shot),
        # "dataset2/train",
    ...
    _PREDEFINED_CD.append(
        ("dataset3_{}shot".format(shot),
         "dataset3/train_aug",
        "dataset3/annotations_aug/{}_shot.json".format(shot))
    )
