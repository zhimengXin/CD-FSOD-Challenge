...
- Prototypes generated: bash build_prototypes.sh (This process follows [DE-ViT](https://github.com/mlzxy/devit/blob/main/Downloads.md)(custom dataset))
  
- If you are using dataset2, please run: bash pseudo_loop.sh
